...
for iterclf,iterlabel in zip([weak_l1,weak_l2,weak_l3,stackingclf],["K-nearest Neighbor model","random forest model","nNaive Bayes model","Stacking classifier model"]):
